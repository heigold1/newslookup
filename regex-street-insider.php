...
function regexStreetInsider($streetInsiderNews)
{
  ...
  $streetInsiderNews = preg_replace('/ merger/i', '<span style="font-size: 55px; background-color:red; color:black"><br><br><b>&nbsp; MERGER<br><br> - STAY AWAY</b></span><span style="font-size: 25px; background-color:red; color:black"><br><br><b>&nbsp; LET IT SETTLE FOR A COUPLE DAYS</b></span>&nbsp;', $streetInsiderNews);
  ...
  $streetInsiderNews = preg_replace('/ enters partnership/i', '<span style="font-size: 20px; background-color:#00ff00; color:black; "><b>ENTERS PARTNERSHIP - THIS IS OK AT 40%</b></span>&nbsp;', $streetInsiderNews);
  $streetInsiderNews = preg_replace('/ announces partnership/i', '<span style="font-size: 20px; background-color:#00ff00; color:black; "><b>ANNOUNCES PARTNERSHIP - THIS IS OK AT 40%</b></span>&nbsp;', $streetInsiderNews);
