  ...
  $current_time = date('Gis'); 
    ...
    if ($current_time > 200000)  // 1:00 PM 
    {
      ...
      if (isset($mkt_response_obj->QuoteData->All->lastTrade))
      {
        ...
        $extended_hour_last_trade = (string) $mkt_response_obj->QuoteData->All->ExtendedHourQuoteDetail->lastPrice; 
        ...
        $dataArray['high'] = $high; 
        $dataArray['bid'] = $bid; 
        $dataArray['last_trade'] = $last_trade; 
        $dataArray['ten_day_volume'] = $ten_day_volume; 
        $dataArray['extended_hour_last_trade'] = $extended_hour_last_trade; 
